      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="relative flex flex-col items-center max-w-xs p-8 rounded-2xl backdrop-blur-sm bg-gradient-to-br from-white/10 to-transparent border border-white/10 overflow-hidden">
            ...
            <motion.div 
              className="absolute inset-0 bg-gradient-to-br from-ignis-red/20 via-ignis-gold/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"
            />
    ...
    <div className="min-h-screen relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              <FeatureCard
                ...
                description="Sesiones personalizadas con bomberos profesionales para resolver tus dudas."
                icon={<BrandIcon />}
              />
            </motion.div>
          </div>
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto py-16">
          {/* Elementos visuales para transición */}
          <div className="absolute -left-24 top-1/2 transform -translate-y-1/2 w-48 h-48 bg-ignis-red/5 rounded-full blur-xl"></div>
          <div className="absolute -right-24 top-1/2 transform -translate-y-1/2 w-48 h-48 bg-ignis-gold/5 rounded-full blur-xl"></div>
        </div>
      </div>
      ...
      <section className="section-padding py-16 relative overflow-hidden bg-secondary">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <motion.div
            className="absolute top-1/3 left-1/2 transform -translate-x-1/2 w-[700px] h-[700px] rounded-full opacity-20"
            style={{
          ...
          {Array.from({ length: 10 }).map((_, i) => (
            <motion.div
              key={i}
              className="absolute rounded-full bg-ignis-gold/20"
              style={{
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="text-center mb-16 mt-6">
            <motion.h2
              className="mb-6 text-white font-bold text-4xl md:text-5xl"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <PlatformFeature
              ...
              title="Temarios Digitales"
              description="Contenido actualizado y adaptado para las oposiciones. Accede desde cualquier dispositivo, en cualquier momento."
              delay={0}
            />
            ...
            <PlatformFeature
              ...
              title="Tests Dinámicos"
              description="Evalúa tu progreso con tests adaptativos que identifican tus puntos débiles y mejoran tu rendimiento."
              delay={0.1}
            />
            ...
            <PlatformFeature
              ...
              title="Clases Online"
              description="Sesiones en directo y grabadas impartidas por bomberos profesionales y expertos en cada materia."
              delay={0.2}
            />
            ...
            <PlatformFeature
              ...
              description="Organiza tu estudio de forma eficiente con un calendario que se adapta a tus horarios y necesidades."
              delay={0.3}
            />
            ...
            <PlatformFeature
              ...
              description="Visualiza tu progreso y compara tu rendimiento con estadísticas detalladas de cada área de estudio."
              delay={0.4}
            />
            ...
            <PlatformFeature
              ...
              title="Mentorías One-to-One"
              description="Sesiones personalizadas con bomberos profesionales para resolver tus dudas y guiarte en tu preparación."
              delay={0.5}
            />
          </div>
          ...
          >
            <a
              href="#waitlist"
              className="inline-flex items-center px-8 py-3 rounded-lg bg-ignis-red hover:bg-ignis-red/90 text-white font-medium transition-all duration-300 group"
            >
      ...
      <section 
        id="waitlist" 
        className="section-padding pt-32 bg-gradient-to-br from-ignis-red via-secondary to-secondary relative overflow-hidden"
      >
        {/* Elementos decorativos */}
        ...
        <div className="container mx-auto relative z-10">
          <motion.div 
            className="text-center max-w-3xl mx-auto mb-10 relative"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.3 }}
            variants={fadeInUpVariants}
      ...
      <motion.button 
        className={cn(
          "fixed bottom-8 right-8 bg-ignis-red text-white p-3 rounded-full shadow-lg z-50 transition-opacity duration-300",
